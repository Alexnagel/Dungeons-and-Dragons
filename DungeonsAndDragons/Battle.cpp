...
Battle::Battle() : enemies(std::vector<Enemy*>()), player(nullptr), finished(false)
{
}

Battle::Battle(std::vector<Enemy*> p_enemies, Player* p_player) : enemies(p_enemies), player(p_player), finished(false)
{
}
